...
(function (BadgeStyle) {
    ...
    BadgeStyle[BadgeStyle["Globe"] = 31] = "Globe";
    BadgeStyle[BadgeStyle["GlobeBg"] = 32] = "GlobeBg";
...
Color.badger = new Color(8,33,58, 155);
...
class UIMenuItem {
    constructor(text, description = "", data = null) {
        ...
        this.Enabled = true;
        this.Data = data;
        this._rectangle = new ResRectangle(new Point(0, 0), new Size(431, 38), new Color(34,80,127,120));
        this._text = new ResText(text, new Point(8, 0), 0.5, Color.White, Font$1.CharletComprimeColonge, Alignment$1.Left);
        ...
        this._labelText = new ResText("", new Point(0, 0), 0.5, Color.White, 4, Alignment$1.Centered);
    }
    get Text() {
    ...
    SetVerticalPosition(y) {
        ...
        this._labelText.Pos = new Point(250 + this.Offset.X, y + 142 + this.Offset.Y);
    }
    addEvent(event, ...args) {
            ...
            this._badgeRight.Color = this.IsBagdeWhiteSprite(this.RightBadge)
                ? this.Enabled
                    ? this.Selected
                        ? this.HighlightedForeColor
                        : this.ForeColor
                    : new Color(0, 0, 148,120)
                : Color.badger;
            this._badgeRight.Draw();
        }
        if (this.RightLabel && this.RightLabel !== "") {
            this._labelText.Pos = new Point(405 + this.Offset.X + this.Parent.WidthOffset, this._labelText.Pos.Y);
    ...
    BadgeToSpriteLib(badge) {
        switch (badge) {
            ...
            case BadgeStyle$1.Globe:
            case BadgeStyle$1.GlobeBg:
                return "mprankbadge";
            default:
                return "commonmenu";
        }
...
UIMenuItem.DefaultHighlightedForeColor = Color.White;
